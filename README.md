# Portfolio Nabil Chakil

Site statique responsive pour presenter des projets etudiants en web, UI et design.

## Fichiers

- `index.html` : contenu, projets, sections et liens.
...
- Section `#linkedin` : liens vers le profil LinkedIn et l'email.

## Personnalisation rapide

1. Remplacer `Nabil Chakil` si le nom change.
